...
public class SslSession : IDisposable
{
    ...
    /// </summary>
    public virtual void ReceiveAsync() => TryReceive(); // Try to receive data from the client
    ...
    private void TryReceive()
    {
        ...
        try
        {
            ...
            do
            {
                ...
                _receiving = true;
                result = _sslStream.BeginRead(_receiveBuffer.Data, 0, (int)_receiveBuffer.Capacity, ProcessReceive,
                    _sslStreamId);

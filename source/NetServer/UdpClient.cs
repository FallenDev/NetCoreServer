...
public class UdpClient : IDisposable
{
    ...
    protected virtual Socket CreateSocket() => new(Endpoint.AddressFamily, SocketType.Dgram, ProtocolType.Udp);
    ...
    /// </summary>
    public virtual void ReceiveAsync() => TryReceive(); // Try to receive datagram
    ...
    private void ProcessReceiveFrom(SocketAsyncEventArgs e)
    {
        ...
        if (_receiveBuffer.Capacity != size) return;
